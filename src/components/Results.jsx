...
const categoryLabels = {
  ...
  nyla_count: '🍎 Je compte',
  nyla_add: '➖ Ajouter et enlever',
  nyla_letters: '🔤 Les lettres',
  nyla_sight_words: '⭐ Mots-étoiles',
  nyla_compare: '⚖️ Plus, moins, autant',
  nyla_shapes: '⬜ Les formes',
  nyla_patterns: '🔄 Suites logiques',
  nyla_rhymes: '🎵 Rimes et sons',
  nyla_syllabes: '👏 Mes syllabes',
  nyla_fusion: '🧩 Je fusionne',
  nyla_couleurs: '🎨 Les couleurs',
  nyla_tri: '🧺 Trier et comparer',
  nyla_saisons: '🌦️ Saisons et météo',
  nyla_prenom: '✍️ Mon prénom',
  nyla_1re_sons: '🔊 Le son de la semaine',
  nyla_1re_lecture: '📖 Je lis',
  nyla_oral: '🗣️ On parle ensemble',
  dictee_orale: '🎙️ Dictée à voix haute',
  aquarium: 'Aquarium',
  speed: 'Course',
  memory: 'Mémoire',
};
