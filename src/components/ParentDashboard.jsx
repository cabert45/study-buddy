...
const categoryLabels = {
  ...
  nyla_count: '🍎 Compte (Nyla)',
  nyla_add: '➕ Additions (Nyla)',
  nyla_letters: '🔤 Lettres (Nyla)',
  nyla_sight_words: '⭐ Mots-étoiles (Nyla)',
  nyla_compare: '⚖️ Compare (Nyla)',
  nyla_shapes: '⬜ Formes (Nyla)',
  nyla_patterns: '🔄 Suites (Nyla)',
  nyla_rhymes: '🎵 Rimes et sons (Nyla)',
  nyla_syllabes: '👏 Syllabes (Nyla)',
  nyla_fusion: '🧩 Fusion de sons (Nyla)',
  nyla_couleurs: '🎨 Couleurs (Nyla)',
  nyla_tri: '🧺 Trier et comparer (Nyla)',
  nyla_saisons: '🌦️ Saisons et météo (Nyla)',
  nyla_prenom: '✍️ Mon prénom (Nyla)',
